...
public class UpdateMemberRoleServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer targetUserId = parseId(request.getParameter("targetUserId"));
        String action = request.getParameter("action");

        if (nationId == null || targetUserId == null) {
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/nation?id=" + nationId + "&roleError=" + encodedError);
